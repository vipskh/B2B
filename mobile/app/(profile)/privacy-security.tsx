      ...
      >
            ...
            >
              <View className="flex-row items-center">
                <View className="bg-primary/20 rounded-full w-12 h-12 items-center justify-center mr-4">
                  <Ionicons name={setting.icon as any} size={24} color="#FF6A00" />
                </View>
                ...
                {setting.type === "toggle" ? (
                  <Switch
                    ...
                    thumbColor="#FFFFFF"
                    trackColor={{ false: "#2A2A2A", true: "#FF6A00" }}
        ...
        <View className="px-6 pt-6 pb-4">
          <View className="bg-primary/10 rounded-2xl p-4 flex-row">
            <Ionicons name="information-circle-outline" size={24} color="#FF6A00" />
